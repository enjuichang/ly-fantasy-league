        ...
        return (
            <Card className="max-w-md mx-auto mt-10">
                <CardHeader>
                    ...
                    <CardDescription>You need a team to participate in {league.name}</CardDescription>
                </CardHeader>
                <CardContent>
                    <form action={createTeam.bind(null, id)} className="flex flex-col gap-4">
                        <div className="grid w-full items-center gap-1.5">
                            <Label htmlFor="name">Team Name</Label>
                            <Input type="text" id="name" name="name" placeholder="e.g. The Lawmakers" required />
                        </div>
        ...
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                ...
                <div className="text-lg font-semibold text-slate-600">
                    Total Points: {teamTotalPoints.toFixed(1)}
                </div>
            </div>
